...
public class Step1 {
    ...
    public static class Step1_ToItemPreMapper extends MapReduceBase implements Mapper<LongWritable, Text, IntWritable, Text> {
...
//            long kk = Integer.parseInt(key.toString());
